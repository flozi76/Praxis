...
namespace Duftfinder.Web.Models
{
    ...
    public class UserViewModel : RegisterViewModel
    {
        ...
        {
            get { return _user.IsAccountVerified; }
            set { _user.IsAccountVerified = value; }
        }
        public bool IsConfirmed
        {
            get { return _user.IsConfirmed; }
            set { _user.IsConfirmed = value; }
        }

        public bool IsInactive
        {
            get { return _user.IsInactive; }
            set { _user.IsInactive = value; }
        }

        public bool IsSystemAdmin
        {
            get { return _user.IsSystemAdmin; }
            set { _user.IsSystemAdmin = value; }
        }

        public string RoleId
        {
            get { return _user.RoleIdString; }
        ...
        public IList<SelectListItem> RoleListItems
        {
            get
            {
                ...
                foreach (Role role in Roles)
                {
                    ...
                    SelectListItem roleListIem = new SelectListItem();
                    if (RoleValueDisplayName == RoleValue.Friend.ToString())
                    {
                        roleListIem = new SelectListItem {Text = RoleValueDisplayName, Value = role.Id, Selected = true};
                    }
                    else
                    {
        ...
        /// </summary>
        /// <author>Anna Krebs</author>
        public string RoleValueDisplayName
        {
            get { return _roleValue?.Display(); }
        }
        ...
        {
            get { return _roleValue.ToString(); }
            set
            {
                RoleValue r;
