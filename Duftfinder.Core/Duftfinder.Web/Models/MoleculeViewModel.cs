    ...
    public class MoleculeViewModel
    {
        ...
        public string Name
        {
            get
            {
                ...
                if (IsGeneral)
                {
                    return $"{SubstanceValueDisplayName} {Resources.Resources.Molecule_General}";
                }
        ...
        {
            get { return _molecule.IsGeneral; }
            set { _molecule.IsGeneral = value; }
        }

        public string SubstanceId
        {
            get { return _molecule.SubstanceIdString; }
