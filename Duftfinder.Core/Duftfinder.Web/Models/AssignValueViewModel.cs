...
namespace Duftfinder.Web.Models
{
    ...
    public class AssignValueViewModel
    {
        ...
        [Range(0, 100, ErrorMessageResourceType = typeof(Resources.Resources), ErrorMessageResourceName = "Error_InputRangeMin0Max100")]
        public double? MoleculePercentage { get; set; }

        public string SubstanceIdString { get; set; }

        [Range(0, 4, ErrorMessageResourceType = typeof(Resources.Resources), ErrorMessageResourceName = "Error_InputRangeMin0Max4")] 
