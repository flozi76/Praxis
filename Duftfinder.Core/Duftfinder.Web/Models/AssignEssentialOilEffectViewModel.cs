...
namespace Duftfinder.Web.Models
{
    ...
    public class AssignEssentialOilEffectViewModel
    {
        ...
        public AssignEssentialOilEffectViewModel(EssentialOil essentialOil, Effect effect, IList<AssignValueViewModel> assignValueViewModel, IList<Category> categories)
        {
        ...
        public IList<string> AlphabeticalIndexes
        {
            get
            {
                ...
                foreach (AssignValueViewModel assignValueViewModel in AssignEssentialOils)
                {
                    // Add first letter to list, if it doesn't already exist.
                    string firstLetter = assignValueViewModel.AssignedValueName.Substring(0, 1).ToUpper();
