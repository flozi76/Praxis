var UserAdmin = (function() {
    ...
    var notifyAccountNotVerifiedUrl =
        "/UserAdmin/ShowNotifyAccountNotVerified"; // IMPORTANT: This url MUST have a / as a prefix. Otherwise Controller won't be called.
    var notifyEmailWillBeSentToUserUrl =
        "/UserAdmin/ShowNotifyEmailWillBeSentToUser"; // IMPORTANT: This url MUST have a / as a prefix. Otherwise Controller won't be called.
    ...
    function initializeElements() {
        ...
        $("#user-admin .delete-buttons").on("click",
            function(e) {
                Dialog.showDialog(e, confirmDeleteUrl);
            });

        // Click on "vom Admin bestätigt" checkbox.
        $("#user-admin-form #cb-is-confirmed").on("click",
            function(e) {
