...
namespace Duftfinder.Business.Services
{
    ...
    public abstract class Service<TEntity, TFilter, TRepository> : IService<TEntity, TFilter> where TEntity : Entity where TFilter : Filter where TRepository : IRepository<TEntity, TFilter>
    {
        ...
        {
            Task<ValidationResultList> validationResult = Repository.InsertAsync(entity);
        ...
        {
            Task<ValidationResultList> validationResult = Repository.UpdateAsync(entity);
        ...
        {
            Task<ValidationResultList> validationResult = Repository.DeleteAsync(id);
